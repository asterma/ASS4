...
if("TRUE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /home/sikun/Documents/Robotics/ASS4/workspace_assignment4/src/localization)
  set(localization_DEVEL_PREFIX /home/sikun/Documents/Robotics/ASS4/workspace_assignment4/devel)
  ...
  set(localization_INSTALL_PREFIX /home/sikun/Documents/Robotics/ASS4/workspace_assignment4/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer ' <clemens.eppner@tu-berlin.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sikun/Documents/Robotics/ASS4/workspace_assignment4/src/localization/${idir}'.  Ask the maintainer ' <clemens.eppner@tu-berlin.de>' to fix it.")
    endif()
